...
.org-string { color: %s !important; }
  ...
  (defun my/org-mode-after-setup ()
    ...
    (add-to-list 'org-structure-template-alist '("u" . "src plantuml :file ?.png :cmdline -charset UTF-8"))
    (add-to-list 'org-structure-template-alist '("t" . "src typescript :cmdline -t es6"))
...
(use-package ox-gfm
  ...
  (advice-add 'org-gfm-format-toc :override #'my/org-gfm-format-toc))
