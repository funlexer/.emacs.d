...
.org-string { color: %s !important; }
  ...
  (defun u/org-mode-after-setup ()
    ...
    (add-hook 'enable-theme-functions
              (lambda (theme) (u/update-org-html-theme)))
    (advice-add 'disable-theme
                :after (lambda (&rest _) (u/update-org-html-theme))))
  :hook (org-mode . u/org-mode-after-setup)
  :custom
...
(use-package go-mode
  ...
  (defun u/project-find-go-module (dir)
  ...
  ;; 전역 hook 설정 추가
  (add-hook 'project-find-functions #'u/project-find-go-module)
...
(use-package js2-mode
  ...
  (("\\.js\\'" . js2-mode))
  :preface
  (defun u/js-setup-indent ()
    (setq-local tab-width 2)
    (setq-local js-indent-level 2)
    (setq-local js2-basic-offset 2))
  :hook
  ((js-mode . u/js-setup-indent)
   (js2-mode . u/js-setup-indent)))
...
(use-package k8s-mode
  ...
  (add-to-list 'magic-mode-alist '("apiVersion:" . yaml-mode))
...
(add-hook 'ielm-mode-hook
          (lambda ()
            (keymap-set u/key-map "C-j" 'ielm-return)))
#+end_src
...
#+begin_src emacs-lisp
(keymap-set u/key-map "C-c p" 'projectile-command-map)
#+end_src
