...
(use-package treemacs
  ...
  :hook
  ((treemacs-mode . my/disable-line-numbers-mode)))
...
(use-package yaml-mode
  :after (evil)
  :config
  (defun my/yaml-format-region (beg end)
    "Format YAML region using yamlfmt."
    (interactive "r")
    (shell-command-on-region beg end "yamlfmt -" nil t))
  (evil-define-operator my/evil-yaml-indent (beg end)
    :move-point nil
    (my/yaml-format-region beg end))
